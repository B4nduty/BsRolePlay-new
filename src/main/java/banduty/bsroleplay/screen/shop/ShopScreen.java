...
public class ShopScreen extends HandledScreen<ShopScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(BsRolePlay.MOD_ID, "textures/gui/shop_gui.png");
    ...
    private static final Identifier INCREASE_10K_BUTTON_TEXTURE = new Identifier(BsRolePlay.MOD_ID, "textures/gui/increase_1k.png");
    private static final Identifier INCREASE_10K_BUTTON_HOVER_TEXTURE = new Identifier(BsRolePlay.MOD_ID, "textures/gui/increase_1k_hover.png");
